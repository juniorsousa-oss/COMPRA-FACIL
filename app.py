...
# O diálogo de orçamento também pode iniciar a próxima lista.
...
# Quando não houver lista atual, exibe a opção de iniciar a próxima compra se houver itens guardados.
...
# Mantém o create_product original: ele precisa reutilizar produtos existentes ao fechar uma compra.
# A trava do cadastro de produto será aplicada somente no formulário de novo produto.
